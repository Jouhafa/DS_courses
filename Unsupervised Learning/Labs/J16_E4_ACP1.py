...
"""
Question 1 : Recup�rer les donn�es de data_iris.csv avec pandas (bien faire attention au separateur et a la decimale dans le csv)
"""


"""
Question 2 : A la vue des donnes en 4d, sauriez vous facilement distinguer les differentes vari�t�s d'Iris. Nous allons repondre a cette question en plusieurs etapes.
"""
...
#Question 2.2)  Afin de comparer des mesures ayant la meme echelle, nous allons d'abord centrer et r�duire les valeurs associees a chaque variable. Utilisez 'sklearn.preprocessing.StandardScaler' pour effectuer cette etape simplement.
